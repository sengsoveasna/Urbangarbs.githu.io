...
//function get Id from table score
    ...
    $getCustomerInfo = $db->getOne('tbl_invoice inv','name,email,address,phone,inv.date as orderDate');
	
	$orderDate 		= $getCustomerInfo['orderDate'];
	...
	i.member_price as i_mem_price, i.unit_price as i_unit_price, i.quantity as i_qty, code, title, a.email as ownerEmail');
